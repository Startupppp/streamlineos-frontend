  ...
  return (
    <div className="min-h-screen w-full bg-[#0f2b7f] dark:bg-background flex flex-col items-center justify-center p-4 relative transition-colors duration-300">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-white dark:text-foreground tracking-tight">Reset Password</h1>
        <p className="text-blue-100 dark:text-muted-foreground mt-2">Create a new secure password</p>
      </div>
