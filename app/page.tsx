  ...
  return (
    <div className="flex min-h-screen flex-col font-sans bg-background text-foreground transition-colors duration-300">
      ...
      <main className="flex-1">
        <section className="relative bg-[#0f2b7f] dark:bg-background py-24 lg:py-32 overflow-hidden transition-colors duration-300">
          ...
          <div className="container relative mx-auto px-4 text-center">
            <h1 className="mb-6 text-5xl font-extrabold tracking-tight text-white dark:text-foreground sm:text-6xl">
              Advanced <span className="text-secondary">HR</span> and <span className="text-secondary">Project</span> Management
            </h1>
            <p className="mx-auto mb-10 max-w-3xl text-xl text-blue-100 dark:text-muted-foreground">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link href="/signin">
                <Button size="lg" variant="outline" className="w-full sm:w-auto border-white/20 dark:border-input bg-transparent text-white dark:text-foreground hover:bg-white/10 dark:hover:bg-accent text-lg px-8 py-6 h-auto">
                  Sign In
                </Button>
              </Link>
            </div>
        ...
        {/* Features Section */}
        <section className="bg-slate-50 dark:bg-muted/30 py-24 transition-colors duration-300">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-6xl">
              <div className="text-center mb-16">
                 <h2 className="mb-4 text-3xl font-bold text-primary dark:text-foreground">Everything you need to run your business</h2>
