        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 pt-16 pb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {["About Us", "Careers", "Blog", "Contact"].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-sm text-white/40 hover:text-gold transition-colors duration-200">
                      {item}
                    </a>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-3">
                {["Documentation", "API Reference", "Help Center"].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-sm text-white/40 hover:text-gold transition-colors duration-200">
                      {item}
                    </a>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 py-8">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="text-white/30 hover:text-gold transition-colors duration-200" aria-label="Twitter">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="#" className="text-white/30 hover:text-gold transition-colors duration-200" aria-label="GitHub">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="#" className="text-white/30 hover:text-gold transition-colors duration-200" aria-label="LinkedIn">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
