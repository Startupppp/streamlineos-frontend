    ...
    <div className="flex min-h-screen flex-col font-sans bg-background text-foreground">
      ...
      <main className="flex-1">
        <section className="relative noir-mesh py-24 lg:py-32 overflow-hidden">
             ...
             <div className="absolute top-0 right-0 -mr-20 -mt-20 h-[500px] w-[500px] rounded-full bg-gold/5 blur-3xl" />
             <div className="absolute bottom-0 left-0 -ml-20 -mb-20 h-[300px] w-[300px] rounded-full bg-gold/10 blur-3xl" />

          <div className="container relative mx-auto px-4 text-center">
            <h1 className="mb-6 text-5xl font-extrabold tracking-tight text-foreground sm:text-6xl">
              Advanced <span className="gold-text">HR</span> and <span className="gold-text">Project</span> Management
            </h1>
            <p className="mx-auto mb-10 max-w-3xl text-xl text-foreground/70">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/signup">
                <Button size="lg" className="w-full sm:w-auto text-lg px-8 py-6 h-auto">Get Started</Button>
              </Link>
              <Link href="/signin">
                <Button size="lg" variant="outline" className="w-full sm:w-auto border-border text-foreground hover:bg-accent text-lg px-8 py-6 h-auto">
                  Sign In
                </Button>
              </Link>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-6xl">
              <div className="text-center mb-16">
                 <h2 className="mb-4 text-3xl font-bold text-foreground">Everything you need to run your business</h2>
                 <p className="text-muted-foreground max-w-2xl mx-auto">From recruitment to retirement, and every project in between.</p>
              </div>

              <div className="grid gap-8 md:grid-cols-3">
                <div className="group rounded-xl border border-border bg-card text-card-foreground p-8 shadow-noir transition-all hover:shadow-lg hover:border-gold/30 glow-gold">
                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-gold/10 text-gold group-hover:gold-gradient group-hover:text-primary-foreground transition-colors">
      ...
      <footer className="bg-secondary py-12 text-secondary-foreground">
        <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="flex items-center gap-2">
                     <Image src="/logo.svg" alt="Vaivamm Logo" width={32} height={32} className="rounded-lg bg-white/90 border border-gold/20 p-1" />
                ...
                <nav className="flex items-center gap-6 text-sm text-secondary-foreground/70">
                  <Link href="/signin" className="hover:text-secondary-foreground transition-colors">Sign In</Link>
                  <Link href="/signup" className="hover:text-secondary-foreground transition-colors">Get Started</Link>
                </nav>
