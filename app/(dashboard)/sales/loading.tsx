...
export default function SalesLoading() {
  return (
    <div className="space-y-6">
      ...
      {/* Live CRM Metrics card (7-col grid) */}
      <Card>
        <CardHeader>
        ...
        <CardContent>
          <div className="grid gap-3 grid-cols-2 sm:grid-cols-3 lg:grid-cols-7">
            {Array.from({ length: 7 }).map((_, i) => (
              <div key={i} className="flex flex-col items-center gap-1 p-3 rounded-xl border border-border bg-muted/30">
      ...
      {/* Revenue Trend (7-col) + Pipeline Funnel (5-col) */}
      ...
      {/* Top Deals + Leaderboard + Activity (3-col) */}
