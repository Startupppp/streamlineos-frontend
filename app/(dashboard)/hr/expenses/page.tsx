          ...
          <motion.div variants={fadeUp}>
            <div className="grid gap-3 sm:gap-4 grid-cols-2 lg:grid-cols-4">
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto px-4 py-3" align="start">
                  <p className="text-xs text-muted-foreground mb-1">Exact Amount</p>
                  <p className="text-lg font-bold text-foreground">{formatINR((stats?.approvedAmount || 0) + (stats?.pendingAmount || 0) + (stats?.rejectedAmount || 0) + (stats?.paidAmount || 0))}</p>
                </PopoverContent>
              </Popover>
            </div>
          </motion.div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Card className="shadow-sm hover:shadow-md transition-shadow border">
              <CardContent className="p-4 sm:p-6">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <p className="text-2xl sm:text-3xl font-bold mt-1 truncate cursor-pointer hover:text-primary transition-colors">{formatINRCompact(stats?.pendingAmount || 0)}</p>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto px-4 py-3" align="start">
                    <p className="text-xs text-muted-foreground mb-1">Exact Amount</p>
            ...
            <Card className="shadow-sm hover:shadow-md transition-shadow border">
              <CardContent className="p-4 sm:p-6">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <p className="text-2xl sm:text-3xl font-bold mt-1 truncate cursor-pointer hover:text-primary transition-colors">{formatINRCompact(stats?.rejectedAmount || 0)}</p>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto px-4 py-3" align="start">
                    <p className="text-xs text-muted-foreground mb-1">Exact Amount</p>
