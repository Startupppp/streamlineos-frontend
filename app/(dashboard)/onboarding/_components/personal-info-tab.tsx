...
const personalSchema = z.object({
  phone: z.string().min(10, "Phone number must be at least 10 digits").regex(/^[+]?[\d\s()-]{10,}$/, "Enter a valid phone number"),
  skills: z.string().min(3, "Add at least one skill"),
  experienceYears: z.string().min(1, "Experience is required").refine((v) => Number(v) >= 0, "Experience cannot be negative"),
});
