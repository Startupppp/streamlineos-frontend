...
const SESSION_ONLY_BY_DESIGN: readonly SessionOnlySurface[] = [
  ...
  { path: "/notifications", reason: "Platform core compat redirect to /inbox?view=notifications." },
  { path: "/settings", reason: "The personal account landing page. Everything beneath it is organization administration." },
  { path: "/settings/notifications", reason: "Notification Settings hub — redirects to /settings/notifications/my-preferences." },
