...
const NOT_YET_CONVERTED: readonly string[] = [
  ...
  */
  ...
  // Arrived with the inventory branch (main + inventory lane), which never ran this ratchet;
  // listed so the merge adds no unknown surface, and each still needs its denial state.
  "app/(authenticated)/hr/benefits/page.tsx",
  "app/(authenticated)/hr/devices/page.tsx",
  "app/(authenticated)/notifications/broadcasts/page.tsx",
  "app/(authenticated)/notifications/events/page.tsx",
  "app/(authenticated)/notifications/providers/page.tsx",
  "app/(authenticated)/notifications/templates/page.tsx",
  "components/automations/automation-runs-dialog.tsx",
  "features/billing/ai-credits-settings-page.tsx",
  "features/blog/admin/blog-admin-categories.tsx",
  "features/blog/admin/blog-admin-posts.tsx",
  "features/build/settings/webhook-card.tsx",
  "features/hr/automations/automation-runs-sheet.tsx",
  "features/hr/benefits/dependents-manager.tsx",
  "features/hr/dashboard/hr-leave-calendar.tsx",
  "features/hr/dashboard/hr-onboarding-progress.tsx",
  "features/hr/engagement/campaigns-tab.tsx",
  "features/hr/engagement/polls-tab.tsx",
  "features/hr/enterprise/comp/comp-cycle-list.tsx",
  "features/hr/enterprise/comp/devices-table.tsx",
  "features/hr/enterprise/comp/vesting-timeline.tsx",
  "features/hr/feedback/cycles-tab.tsx",
  "features/hr/feedback/results-tab.tsx",
  "features/hr/global/compliance-events-tab.tsx",
  "features/hr/global/contingent-page-content.tsx",
  "features/hr/kpis/competency-frameworks-tab.tsx",
  "features/hr/kpis/kpi-library-tab.tsx",
  "features/hr/overtime/comp-off-page-client.tsx",
  "features/hr/performance/cycles-tab.tsx",
  "features/hr/performance/meetings-tab.tsx",
  "features/inventory/components/channels/channel-snapshot-diffs-panel.tsx",
  "features/inventory/components/finance/landed-cost-detail-sheet.tsx",
  "features/inventory/components/finance/valuation-evidence-sheet.tsx",
  "features/inventory/components/operations/packing-station-sheet.tsx",
  "features/inventory/components/quality/recall-lot-picker.tsx",
  "features/inventory/components/quick-commerce/platform-po-panel.tsx",
  "features/inventory/components/reports/audit-export-panel.tsx",
  "features/inventory/components/shipping/shipment-tracking-timeline.tsx",
  "features/inventory/components/tools/shelf-life-rules-card.tsx",
  "features/inventory/components/tools/staged-import-runner.tsx",
  "features/payroll/salary-structures/salary-structures-page.tsx",
];
