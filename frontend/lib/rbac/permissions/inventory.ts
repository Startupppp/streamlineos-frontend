...
export const INVENTORY_PERMISSIONS: Permission[] = [
  ...
  { name: "inventory:replenishment:read", resource: "inventory:replenishment", action: "read", description: "View replenishment proposals, transfer recommendations and forecast drift" },
