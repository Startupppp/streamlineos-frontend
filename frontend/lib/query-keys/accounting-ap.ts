...
export const accountingApQueryKeys = {
  accountingAp: {
    ...
    vendors: (params?: Record<string, unknown>) => [...root, "vendors", params] as const,
    vendor: (partyId: string) => [...root, "vendor", partyId] as const,
    documentsAll: [...root, "documents"] as const,
    documents: (params?: Record<string, unknown>) => [...root, "documents", params] as const,
    ...
    payments: (params?: Record<string, unknown>) => [...root, "payments", params] as const,
