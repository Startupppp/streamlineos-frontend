...
const BUILD_ROUTE_MANIFEST: readonly BuildRouteManifestEntry[] = [
  ...
  { route: "/build/[projectId]/settings/access", decision: "KEEP", target: null },
  { route: "/build/[projectId]/settings/agents", decision: "KEEP", target: null },
  { route: "/build/[projectId]/settings/agents/credentials", decision: "KEEP", target: null },
  { route: "/build/[projectId]/settings/automations", decision: "KEEP", target: null },
  { route: "/build/[projectId]/settings/fields", decision: "KEEP", target: null },
  { route: "/build/[projectId]/settings/integrations", decision: "KEEP", target: null },
  {
    route: "/build/[projectId]/settings/integrations/webhooks",
    decision: "KEEP",
    target: null,
  },
  { route: "/build/[projectId]/settings/iterations", decision: "KEEP", target: null },
  { route: "/build/[projectId]/settings/portal", decision: "KEEP", target: null },
  { route: "/build/[projectId]/settings/retention", decision: "KEEP", target: null },
  { route: "/build/[projectId]/settings/views", decision: "KEEP", target: null },
