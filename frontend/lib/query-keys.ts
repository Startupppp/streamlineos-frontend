...
export const queryKeys = {
  ...
  inventory: {
    ...
    pickLists: (params?: Record<string, unknown>) => [...base, "inventory", "pickLists", params] as const,
    pickList: (id: number) => [...base, "inventory", "pickList", id] as const,
    ...
    slowMovingReport: (params?: Record<string, unknown>) => [...base, "inventory", "slowMovingReport", params] as const,
    expiryReport: (params?: Record<string, unknown>) => [...base, "inventory", "expiryReport", params] as const,
