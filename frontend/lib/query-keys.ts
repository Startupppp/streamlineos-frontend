...
export const queryKeys = {
  ...
  dashboard: {
    ...
    recentProjects: (orgId: string) => [...base, "dashboard", "recentProjects", orgId] as const,
    teamAvailability: (orgId: string) => [...base, "dashboard", "teamAvailability", orgId] as const,
    myIssues: (userId: string) => [...base, "dashboard", "myIssues", userId] as const,
    activeSprintSummary: (orgId: string) => [...base, "dashboard", "activeSprintSummary", orgId] as const,
    recentActivity: (orgId: string) => [...base, "dashboard", "recentActivity", orgId] as const,
