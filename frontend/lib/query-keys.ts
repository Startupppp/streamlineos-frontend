...
export const queryKeys = {
  ...
  hr: {
    ...
    payrollCommandCenter: (month?: string) => [...base, "hr", "payrollCommandCenter", month] as const,
    payrollTemplateLibrary: () => [...base, "hr", "payrollTemplateLibrary"] as const,
    payrollTemplatePreview: (key: string) => [...base, "hr", "payrollTemplatePreview", key] as const,
    payrollPolicy: () => [...base, "hr", "payrollPolicy"] as const,
    payrollPolicyVersions: () => [...base, "hr", "payrollPolicyVersions"] as const,
    payrollComponents: (params?: Record<string, unknown>) => [...base, "hr", "payrollComponents", params] as const,
    payrollCalendar: (params?: Record<string, unknown>) => [...base, "hr", "payrollCalendar", params] as const,
    payrollAccountingMappings: () => [...base, "hr", "payrollAccountingMappings"] as const,
    payrollRuns: (params?: Record<string, unknown>) => [...base, "hr", "payrollRuns", params] as const,
    payrollRun: (runId: number) => [...base, "hr", "payrollRun", runId] as const,
    payrollRunEmployees: (runId: number, params?: Record<string, unknown>) => [...base, "hr", "payrollRunEmployees", runId, params] as const,
    payrollRunEmployee: (runId: number, runEmployeeId: number) => [...base, "hr", "payrollRunEmployee", runId, runEmployeeId] as const,
    payrollRunExceptions: (runId: number, params?: Record<string, unknown>) => [...base, "hr", "payrollRunExceptions", runId, params] as const,
    payrollRunVariance: (runId: number) => [...base, "hr", "payrollRunVariance", runId] as const,
    payrollRunApprovals: (runId: number) => [...base, "hr", "payrollRunApprovals", runId] as const,
    payrollRunPayslips: (runId: number) => [...base, "hr", "payrollRunPayslips", runId] as const,
    payrollBankBatches: (params?: Record<string, unknown>) => [...base, "hr", "payrollBankBatches", params] as const,
    payrollBankBatch: (batchId: number) => [...base, "hr", "payrollBankBatch", batchId] as const,
    payrollEmployeeProfiles: (params?: Record<string, unknown>) => [...base, "hr", "payrollEmployeeProfiles", params] as const,
    payrollEmployeeProfile: (userId: string) => [...base, "hr", "payrollEmployeeProfile", userId] as const,
    payrollInputs: (params?: Record<string, unknown>) => [...base, "hr", "payrollInputs", params] as const,
    payrollLoans: (params?: Record<string, unknown>) => [...base, "hr", "payrollLoans", params] as const,
    payrollLoanAdjustments: (loanId: number) => [...base, "hr", "payrollLoanAdjustments", loanId] as const,
    payrollTaxDeclarationsAdmin: (params?: Record<string, unknown>) => [...base, "hr", "payrollTaxDeclarationsAdmin", params] as const,
    payrollReports: (kind: string, params?: Record<string, unknown>) => [...base, "hr", "payrollReports", kind, params] as const,
    payslipTemplates: () => [...base, "hr", "payslipTemplates"] as const,
    payrollEssOverview: () => [...base, "hr", "payrollEssOverview"] as const,
    payrollEssPayslips: (params?: Record<string, unknown>) => [...base, "hr", "payrollEssPayslips", params] as const,
    payrollEssDeclarations: () => [...base, "hr", "payrollEssDeclarations"] as const,
    payrollEssLoans: () => [...base, "hr", "payrollEssLoans"] as const,
    payrollSettings: () => [...base, "hr", "payrollSettings"] as const,
