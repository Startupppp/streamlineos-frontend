    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-40">
        ...
        <DropdownMenuItem
          ...
          className={!vendor.isActive ? "text-status-success-ink" : undefined}
        >
...
export default function VendorsListPage() {
  ...
  const filterBar = (
    <div className="flex w-full min-w-0 flex-nowrap items-center gap-2 overflow-x-auto scrollbar-hide lg:gap-3 [&>*]:shrink-0">
      <SearchInput className="min-w-0 flex-1" value={search} onValueChange={handleSearchChange} placeholder="Search vendors…" />
