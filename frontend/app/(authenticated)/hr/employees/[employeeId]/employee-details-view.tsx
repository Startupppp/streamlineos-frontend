...
function StatBlock({ label, value, colorClass }: { label: string; value: string | number; colorClass?: string }) {
  return (
    <div className="text-center px-4 first:pl-0 last:pr-0">
      <p className={cn("text-3xl font-bold tabular-nums", colorClass ?? "text-foreground")}>{value}</p>
    ...
    <Card className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
      <CardContent className="p-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-foreground">Manager Scorecard</h3>
        </div>
...
export function EmployeeDetailsView({ employee }: { employee: EmployeeData }) {
  ...
  const employmentStatus =
    typeof (employee as Record<string, unknown>).employmentStatus === "string"
      ...
      : null;
  const isAlreadyTerminated = employee.isActive === false || employmentStatus === "TERMINATED";
  const canTerminate =
    !isAlreadyTerminated &&
    canDeleteEmployee(
    ...
    <>
      <PageWrapper
        ...
        actions={
          <div className="flex items-center gap-1.5">
            <Button variant="ghost" size="sm" className="h-8 gap-1.5" onClick={handleBack}>
      ...
      >
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <div className="shrink-0">
                <Avatar className="h-20 w-20">
                  <AvatarImage
                    src={resolveImageUrl(typeof employee.image === "string" ? employee.image : null)}
                  />
              ...
              <div className="flex-1 min-w-0 space-y-3">
                ...
                <div className="flex flex-wrap gap-x-5 gap-y-2.5">
                  ...
                  <InfoField
                    icon={Building2}
                    label="Department"
                    value={typeof employee.departmentName === "string" ? employee.departmentName : null}
                  />
                  <InfoField
                    icon={Calendar}
                    label="Joined"
                ...
                {isSelf && completeness < 100 && (
                  <div className="space-y-1.5 pt-1">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[11px] font-bold text-foreground">{completeness}%</span>
                    </div>
        ...
        <Tabs defaultValue={defaultTab} className="flex flex-col flex-1 min-h-0">
          ...
          <TabsContent value="overview" className="flex-1 min-h-0 overflow-y-auto mt-3">
                ...
                <Card className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
                  <CardContent className="p-4">
                    ...
                    <EmployeeProjectsList
                      projects={
                        (projects ?? []) as unknown as Parameters<typeof EmployeeProjectsList>[0]["projects"]
                      }
                    />
                  </CardContent>
                </Card>
                <Card className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="text-sm font-semibold text-foreground">Assigned Tickets</h3>
                    </div>
                    <EmployeeTicketsList
                      tickets={
                        (ticketsResult?.data ?? []) as Parameters<typeof EmployeeTicketsList>[0]["tickets"]
                      }
                    />
                  </CardContent>
                </Card>
          ...
          <TabsContent value="attendance" className="flex-1 min-h-0 overflow-y-auto mt-3">
            <div className="pb-6">
          ...
          {isSelf && (
            <TabsContent value="my-profile" className="flex-1 min-h-0 overflow-y-auto mt-3">
              <div className="pb-4">
                <SelfEditProfileForm
          ...
          <TabsContent value="profile" className="flex-1 min-h-0 flex flex-col mt-3">
