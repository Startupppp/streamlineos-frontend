  ...
  if (!expanded) {
    return (
      <Button
        size="sm"
        variant="outline"
        className="h-8 gap-1 text-xs border-rose-200 text-rose-600 hover:bg-rose-50"
...
function SectionHeader({ title, count }: { title: string; count: number }) {
  return (
    <div className="flex items-center gap-2 mb-3">
      ...
      <span className="inline-flex items-center px-1.5 py-0.5 rounded-md bg-blue-50 text-blue-700 text-[11px] font-medium border border-blue-200/70">
        {count}
      </span>
    </div>
  );
