...
import { RoutingRuleCard } from "@/features/support/settings/routing-rule-card";
import { RoutingRuleSheet } from "@/features/support/settings/routing-rule-sheet";
import {
...
export default function SupportRoutingPage() {
  ...
  const [deleteTarget, setDeleteTarget] = useState<SupportRoutingRule | null>(
    null,
  );
  const [orderedRules, setOrderedRules] = useState<SupportRoutingRule[]>(
    rules ?? [],
  );
