...
import { CalendarView } from "@/features/build/views/calendar-view";
import { GanttView } from "@/features/build/views/gantt-view";
import { WorkloadView } from "@/features/build/views/workload-view";

const KanbanBoard = dynamic(
  () => import("@/features/build/views/kanban-board").then((m) => m.KanbanBoard),
  { ssr: false, loading: () => <KanbanBoardSkeletonInline /> },
);

const ListView = dynamic(
  () => import("@/features/build/views/list-view").then((m) => m.ListView),
...
import { hydrateDisplayOptions, useDisplayOptions } from "@/features/build/views/use-display-options";
...
import { SaveViewDialog, type SaveViewMeta } from "@/features/build/views/save-view-dialog";
