...
import { useCrmPerson } from "@/hooks/api";
...
export default function PersonDetailPage() {
  ...
  const healthDistribution = isCSM
    ? [
        {
          label: "Healthy",
          value: person.accounts.filter((a) => a.health === "healthy").length,
          color: "#10B981",
        },
        {
          label: "At Risk",
          value: person.accounts.filter((a) => a.health === "at_risk").length,
          color: "#F59E0B",
        },
        {
          label: "Critical",
          value: person.accounts.filter((a) => a.health === "critical").length,
          color: "#EF4444",
        },
      ].filter((d) => d.value > 0)
    : [];
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    <h1 className="font-display text-xl sm:text-2xl font-extrabold tracking-[-0.02em] text-foreground break-words">
                      {person.name}
                    </h1>
                    <span
                      className={cn(
