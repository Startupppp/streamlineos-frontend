...
import { PlatformAdminsSection } from "@/features/platform/platform-admins-section";
...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <div className="mb-3">
          <h2 className="font-semibold text-slate-900 text-[15px]">Platform admins</h2>
          <p className="text-[12px] text-slate-500 mt-0.5">
            Users who can access the /owner panel. Add by email — the user must already have an account.
          </p>
        </div>
