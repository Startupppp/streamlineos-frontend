    ...
    <div className="rounded-xl border border-border bg-card p-4">
      <Tabs defaultValue="credentials">
        <TabsList className="h-8 rounded-lg border p-1 bg-muted/40">
          <TabsTrigger value="credentials" className="text-xs h-6 px-3 rounded-md">Credentials</TabsTrigger>
          <TabsTrigger value="webhooks" className="text-xs h-6 px-3 rounded-md">Webhooks</TabsTrigger>
          <TabsTrigger value="test-payment" className="text-xs h-6 px-3 rounded-md">Test Payment</TabsTrigger>
          {environment === "live" && (
            <TabsTrigger value="activate" className="text-xs h-6 px-3 rounded-md">Live Activation</TabsTrigger>
          )}
          <TabsTrigger value="audit" className="text-xs h-6 px-3 rounded-md">Audit</TabsTrigger>
        </TabsList>
