    ...
    <div className="rounded-xl border border-border bg-card p-4 space-y-4">
      ...
      {readiness.blockers.length > 0 && (
        <div className="space-y-1.5">
          <p className="text-[11px] font-semibold text-rose-700 uppercase tracking-wide">Blockers</p>
          {readiness.blockers.map((blocker) => (
            <div key={blocker} className="flex items-start gap-1.5 text-[12px] text-rose-700">
      ...
      {readiness.warnings.length > 0 && (
        <div className="space-y-1.5">
          <p className="text-[11px] font-semibold text-amber-700 uppercase tracking-wide">Warnings</p>
          {readiness.warnings.map((warning) => (
            <div key={warning} className="flex items-start gap-1.5 text-[12px] text-amber-700">
      ...
      {readiness.completedChecks.length > 0 && (
        <div className="space-y-1.5">
          <p className="text-[11px] font-semibold text-emerald-700 uppercase tracking-wide">Completed</p>
