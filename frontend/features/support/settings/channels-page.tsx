...
import { channelSchema, type ChannelForm } from "./channel-form.schema";
    ...
    (data: ChannelForm) => {
      ...
      if (isEdit) {
        ...
        create.mutate(
          ...
          {
            onSuccess: () => { toast.success("Channel created"); onClose(); },
            onError: (error) => toast.error(getErrorMessage(error)),
          },
        );
      }
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>The org member this shared inbox is attributed to.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
    ...
    >
      {isLoading ? (
        ...
        <EmptyState
          ...
          action={canManage ? { label: "New Channel", onClick: handleNewChannelAction } : undefined}
          className="flex-1"
        />
      )}
        ...
        <AlertDialog open={!!deleteTarget} onOpenChange={handleDeleteOpenChange}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                &ldquo;{deleteTarget?.name}&rdquo; will be permanently deleted. Inbound messages will
                no longer create tickets through this channel.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
