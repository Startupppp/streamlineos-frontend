...
export function PayrollExceptionsBanner({
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border border-status-warning-rule bg-status-warning-surface px-4 py-3">
      <AlertTriangle className="h-4 w-4 shrink-0 text-status-warning-ink" aria-hidden />
      <p className="flex-1 text-xs text-status-warning-ink">
      ...
      <Button
        variant="outline"
        size="sm"
        className="border-status-warning-rule text-status-warning-ink hover:bg-status-warning-surface shrink-0"
        asChild
      >
