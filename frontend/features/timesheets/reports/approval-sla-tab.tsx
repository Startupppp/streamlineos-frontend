...
const COLUMNS: DataTableColumn<ApprovalSlaApprover>[] = [
  ...
  },
  {
    ...
    cell: (row) =>
      row.pendingCount > 0 ? (
        <Badge className="border px-1.5 py-0 text-micro bg-amber-50 dark:bg-amber-500/10 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-500/30">
