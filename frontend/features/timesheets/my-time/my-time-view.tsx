...
import { useCurrentPeriod, useSubmitPeriod, useRecallPeriod, useTimesheetEntries } from "@/hooks/api/timesheets";
        ...
        {periodLoading ? (
          ...
          <Tabs defaultValue="week">
            <TabsList className="h-8">
              <TabsTrigger value="timer" className="text-xs h-7">Timer</TabsTrigger>
              <TabsTrigger value="week" className="text-xs h-7">Week</TabsTrigger>
              <TabsTrigger value="day" className="text-xs h-7">Day</TabsTrigger>
            </TabsList>
