...
export function ContactTableView({
  ...
  const columns = useMemo<DataTableColumn<Contact>[]>(
    () => [
      {
        ...
        cell: (c) => (
          <div className="flex items-center gap-2">
            <div className="h-6 w-6 rounded-full bg-primary/10 flex items-center justify-center text-micro font-semibold text-primary shrink-0">
    ...
    [sourceOptions, isEnrichPending, onRequestDelete, onEdit, onEnrich],
  );
