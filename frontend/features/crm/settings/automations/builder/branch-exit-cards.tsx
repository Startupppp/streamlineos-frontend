  ...
  return (
    <div className="flex items-center gap-2 rounded-lg border border-border bg-muted/10 px-3 py-2">
      <div className="flex flex-1 items-center gap-2 min-w-0">
        ...
        <Input className="h-7 text-xs flex-1 min-w-0" placeholder="field" value={branch.condition.field} onChange={handleFieldChange} />
        ...
        <Input className="h-7 text-xs flex-1 min-w-0" placeholder="value" value={branch.condition.value} onChange={handleValueChange} />
      </div>
      {canRemove && (
        <Button
          variant="ghost"
...
export const BranchNodeCard = memo(function BranchNodeCard({ node, dragHandleProps, onAddBranch, onUpdateBranchCondition, onRemoveBranch, onRemoveNode }: BranchNodeCardProps) {
  ...
  return (
    <motion.div layout className="rounded-xl border-2 border-violet-200 bg-violet-50/40 p-3 shadow-sm">
        ...
        <div className="flex-1 space-y-2 min-w-0">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <div className="h-5 w-5 rounded bg-violet-100 flex items-center justify-center text-[10px] font-bold text-violet-700">
                <GitBranch className="h-3 w-3" />
              </div>
              <span className="text-xs font-semibold text-violet-700">Branch</span>
            </div>
          ...
          <Button
            variant="outline"
            size="sm"
            className="h-6 text-[10px] border-dashed border-violet-300 text-violet-700 hover:bg-violet-50"
