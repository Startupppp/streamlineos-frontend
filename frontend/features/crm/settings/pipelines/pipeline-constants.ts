...
export const PIPELINE_TYPES: { value: CrmPipelineType; label: string; badgeClass: string }[] = [
  ...
  { value: "customer_success", label: "CS", badgeClass: "bg-cyan-50 text-cyan-700 border-cyan-200 dark:bg-cyan-500/10 dark:text-cyan-300 dark:border-cyan-500/30" },
  { value: "partner", label: "Partner", badgeClass: "bg-sky-50 text-sky-700 border-sky-200 dark:bg-sky-500/10 dark:text-sky-300 dark:border-sky-500/30" },
