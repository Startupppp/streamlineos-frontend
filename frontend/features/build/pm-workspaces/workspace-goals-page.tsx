...
export function WorkspaceGoalsPage({ pmWorkspaceId }: WorkspaceGoalsPageProps) {
  ...
  const params = useMemo(
    ...
    [pmWorkspaceId, typedStatus, typedLevel, listFilters.debouncedSearch],
  );
        ...
        <PmSection index={0} className="shrink-0">
          <StatCardGrid cols={4}>
            <StatCard
              ...
              icon={Target}
              tone="default"
              isLoading={resolution.kind === "loading"}
            />
            <StatCard
              label="On Track"
              ...
              <EmptyState
                ...
                description={
                  listFilters.isFiltered
                    ? undefined
                    : "Create goals to track this workspace's objectives."
                }
