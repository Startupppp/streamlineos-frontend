          ...
          {pillars.map((p, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -3 }}
                className="group relative rounded-xl border border-slate-200/80 bg-white/70 backdrop-blur-sm p-5 sm:p-6 overflow-hidden hover:border-blue-300/50 hover:shadow-[0_16px_40px_-16px_rgba(30,64,175,0.16)] transition-all duration-300 min-w-0"
              >
