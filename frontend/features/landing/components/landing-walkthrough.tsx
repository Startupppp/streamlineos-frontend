  ...
  return (
    ...
    >
      <motion.div
        ...
        className="lg:[direction:ltr] min-w-0"
      >
        ...
        <ul className="space-y-2.5">
          {step.bullets.map((b) => (
            <li key={b} className="flex items-start gap-3">
              ...
              <span className="text-[13px] sm:text-[14px] text-slate-700 min-w-0">{b}</span>
            </li>
          ))}
        </ul>
      </motion.div>
...
const cardCls = "rounded-lg sm:rounded-xl border border-slate-200 bg-white p-2.5 sm:p-4 shadow-sm";
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-[11px] sm:text-[12px] font-semibold text-slate-900 truncate">{c.name}</p>
              <p className="text-[9px] sm:text-[10px] text-slate-500 font-mono truncate">{c.role}</p>
            </div>
          </div>
