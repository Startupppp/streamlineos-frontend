  ...
  return (
    <section className="relative py-16 lg:py-24 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 lg:px-8">
        ...
        >
          <div className="relative bg-slate-900 p-10 lg:p-16 rounded-2xl">
            <div className="absolute inset-0 pointer-events-none rounded-2xl overflow-hidden">
              <div className="absolute -top-20 left-1/2 -translate-x-1/2 h-[300px] w-[600px] rounded-full bg-blue-600/30 blur-3xl" />
              <div className="absolute bottom-0 right-0 h-[200px] w-[400px] rounded-full bg-cyan-600/20 blur-3xl" />
            </div>

            <div className="relative">
              <div className="inline-flex items-center gap-2 rounded-full bg-blue-500/20 border border-blue-400/30 px-3.5 py-1.5 mb-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <Link href="#pricing">
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-white/20 bg-white/8 text-white hover:bg-white/15 hover:text-white hover:border-white/30 h-12 px-8 text-[15px]"
                  >
                    See pricing
                  </Button>
                </Link>
