  ...
  return (
    <section ref={ref} className="relative py-14 sm:py-16 lg:py-24 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[30%] left-[10%] h-[min(260px,50vw)] w-[min(260px,50vw)] rounded-full bg-blue-300/15 blur-[120px]" />
        <div className="absolute bottom-[20%] right-[10%] h-[min(260px,50vw)] w-[min(260px,50vw)] rounded-full bg-cyan-300/15 blur-[120px]" />
      </div>
      ...
      {/* Mobile / tablet: native snap carousel (touch-friendly, no horizontal page scroll) */}
      ...
      {/* Desktop: scroll-linked horizontal parallax */}
...
function TestimonialCard({
  ...
  return (
    <motion.div
      ...
      className="group relative shrink-0 w-[min(300px,calc(100vw-2.5rem))] sm:w-[360px] lg:w-[400px] rounded-xl border border-slate-200/80 bg-white/90 backdrop-blur-sm p-5 sm:p-6 hover:border-blue-300/70 hover:shadow-[0_20px_48px_-20px_rgba(30,64,175,0.20)] transition-all duration-300"
    >
      ...
      <div className="flex items-center gap-3 pt-4 border-t border-slate-100">
        <span className="h-9 w-9 rounded-full inline-flex items-center justify-center text-[11px] font-bold text-white shrink-0 bg-blue-600">
