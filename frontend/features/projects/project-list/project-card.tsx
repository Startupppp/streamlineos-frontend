...
export const ProjectCard = React.memo(function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <>
      <article
        className={cn(
          "group relative flex h-full cursor-pointer flex-col overflow-hidden rounded-xl border border-border border-l-[3px] bg-card p-2.5 shadow-sm",
      ...
      >
        ...
        <div className="mt-auto space-y-1.5 border-t border-border/80 pt-2">
          {hasTickets ? (
            <>
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-1.5 rounded-md border border-dashed border-border/70 bg-muted/30 px-2 py-1">
          ...
          <div className="flex items-center justify-between gap-1.5">
            <div className="flex min-w-0 flex-1 flex-wrap items-center gap-1">
              {hasTickets ? (
                <>
                  <span className="inline-flex items-center gap-0.5 rounded-md bg-emerald-500/10 px-1 py-0.5 text-[8px] font-medium text-emerald-700 dark:text-emerald-400">
