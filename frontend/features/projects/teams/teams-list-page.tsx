...
import { useProjectTeams, useCreateProjectTeam, useUpdateProjectTeam, useDeleteProjectTeam } from "@/hooks/api/projects/teams";
...
export function TeamsListPage() {
  const canCreate = useCan("projects:teams:create");
