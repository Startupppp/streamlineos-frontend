          ...
          <PmSection index={0}>
            <div className={cn(PM_TOOLBAR, "w-fit p-1")}>
              <TabsList className="h-8 bg-transparent p-0">
                <TabsTrigger value="cases" className="px-3 text-xs data-[state=active]:bg-primary/10 data-[state=active]:text-foreground">
                  Test Cases
                </TabsTrigger>
                <TabsTrigger value="runs" className="px-3 text-xs data-[state=active]:bg-primary/10 data-[state=active]:text-foreground">
                  Test Runs
                </TabsTrigger>
              </TabsList>
            </div>
