...
export function QuickCreateMenu({
  ...
  const canCreateTeam = useCan("projects:teams:create");
  const canManagePortfolio = useCan("projects:portfolios:manage");
  const canManageGoals = useCan("projects:goals:manage");
      ...
      <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
        ...
        <DrawerContent className="flex max-h-[min(92dvh,40rem)] flex-col gap-0 overflow-hidden rounded-t-xl border bg-card p-0 shadow-2xl">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-2 py-2 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
            ...
            {showNewPortfolio ? (
              <QuickCreateDrawerLink
                href="/projects/portfolios?create=1"
                label="New portfolio"
                icon={Briefcase}
              />
            ) : null}
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        {showNewTeam ? (
          <DropdownMenuItem asChild className="cursor-pointer gap-2">
            <Link href="/projects/teams?create=1">
        ...
        {showNewPortfolio ? (
          <DropdownMenuItem asChild className="cursor-pointer gap-2">
            <Link href="/projects/portfolios?create=1">
        ...
        {showNewGoal ? (
          <DropdownMenuItem asChild className="cursor-pointer gap-2">
            <Link href="/projects/goal?create=1">
