...
function EventStatusBadge({ status }: { status: ComplianceEvent["status"] }) {
  ...
  if (status === "overdue") return <Badge className="bg-red-50 text-red-700 border-red-200 dark:bg-red-500/10 dark:text-red-300 dark:border-red-500/30">Overdue</Badge>;
  return <Badge className="bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-500/10 dark:text-amber-300 dark:border-amber-500/30">Pending</Badge>;
}
