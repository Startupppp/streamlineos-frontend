...
> = {
  PRESENT: {
    label: "Present",
    tone: "bg-emerald-500/10 text-emerald-700 border-emerald-200 dark:text-emerald-400 dark:border-emerald-800",
    Icon: Wifi,
  },
  ON_BREAK: {
    label: "On Break",
    tone: "bg-amber-500/10 text-amber-700 border-amber-200 dark:text-amber-400 dark:border-amber-800",
    Icon: Coffee,
  },
  CHECKED_OUT: {
    label: "Checked Out",
    tone: "bg-blue-500/10 text-blue-700 border-blue-200 dark:text-blue-400 dark:border-blue-800",
    Icon: LogOut,
  },
  OFFLINE: {
    label: "Offline",
