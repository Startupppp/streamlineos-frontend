      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col gap-0 p-0">
        ...
        {revealedSecret ? (
          <div className="flex-1 flex flex-col gap-4 px-6 py-6">
            <div className="rounded-lg border border-status-warning-rule bg-status-warning-surface p-4 text-sm text-status-warning-ink space-y-1">
              ...
              <p className="text-xs text-status-warning-ink">
                ...
                <code className="bg-status-warning-surface px-1 rounded">X-StreamlineOS-Signature</code> header
