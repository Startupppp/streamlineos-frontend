          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="e.g. Reception Entrance" className="text-sm" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="192.168.1.100" className="text-sm font-mono" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="e.g. Floor 2, Entrance A" className="text-sm" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
