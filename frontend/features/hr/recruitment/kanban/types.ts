...
export const COLUMNS: ColumnConfig[] = [
  ...
  },
  {
    ...
    headerGradient: "from-gradient-info-from to-gradient-info-to",
    headerText: "text-white",
    dot: "bg-white/80",
  },
  {
    ...
    headerGradient: "from-gradient-warning-from to-gradient-warning-to",
    headerText: "text-white",
    dot: "bg-white/80",
  },
  {
  ...
  },
  {
    ...
    headerGradient: "from-gradient-success-from to-gradient-success-to",
    headerText: "text-white",
    dot: "bg-white/80",
  },
  {
    ...
    headerGradient: "from-gradient-danger-from to-gradient-danger-to",
    headerText: "text-white",
    dot: "bg-white/80",
  },
];
