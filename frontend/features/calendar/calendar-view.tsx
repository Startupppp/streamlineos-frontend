      ...
      <div className="flex min-h-0 flex-1 flex-col gap-3">
        ...
        {eventsIsError && (
          <div className="flex shrink-0 flex-col gap-2 rounded-md border border-amber-200 bg-amber-50 px-3 py-1.5 dark:border-amber-500/30 dark:bg-amber-500/10 sm:flex-row sm:items-center">
            <span className="min-w-0 flex-1 text-dense text-amber-700 dark:text-amber-300">
              {getErrorMessage(eventsError)}
            </span>
            <button
              type="button"
              onClick={handleRetryEvents}
              className="shrink-0 self-start text-dense font-medium text-amber-800 underline underline-offset-2 dark:text-amber-300 sm:self-auto"
            >
              Retry
            </button>
          </div>
