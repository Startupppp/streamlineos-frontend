...
export function isSystemAccountPurpose(value: string): value is SystemAccountPurpose {
  return Object.prototype.hasOwnProperty.call(PURPOSE_LABELS, value);
}

export function getPurposeLabel(value: string): string {
  return isSystemAccountPurpose(value) ? PURPOSE_LABELS[value] : value;
}
