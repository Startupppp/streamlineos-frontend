      ...
      <CardContent>
        <form onSubmit={form.handleSubmit(handleSave)} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="space-y-1.5">
              <Label>GSTIN</Label>
              <Input {...form.register("gstin")} className="h-8 text-xs" placeholder="22AAAAA0000A1Z5" />
            </div>
            <div className="space-y-1.5">
              <Label>PAN</Label>
              <Input {...form.register("pan")} className="h-8 text-xs" placeholder="AAAAA0000A" />
            </div>
            <div className="space-y-1.5">
              <Label>State code</Label>
              <Input {...form.register("stateCode")} className="h-8 text-xs" placeholder="22" />
            </div>
          </div>
          <div className="flex gap-2">
            <LoadingButton type="submit" size="sm" isPending={updateSettings.isPending} loadingText="Saving…">
