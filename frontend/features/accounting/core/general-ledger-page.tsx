    ...
    <PageWrapper
      ...
      actions={
        canExport && hasDateRange ? (
          <Button size="sm" variant="outline" onClick={handleExport} {...exportHoverHandlers}>
        ...
        <div className="space-y-2">
          <div className={FILTER_TOOLBAR_ROW}>
            <div className="flex items-center gap-1.5">
              <label htmlFor="gl-from" className="text-xs text-muted-foreground whitespace-nowrap">
                From
              </label>
              <DatePicker id="gl-from" value={from} onChange={handleFromChange} placeholder="Start" className="w-[150px]" />
            </div>
            <div className="flex items-center gap-1.5">
              <label htmlFor="gl-to" className="text-xs text-muted-foreground whitespace-nowrap">
                To
              </label>
              <DatePicker id="gl-to" value={to} onChange={handleToChange} placeholder="End" className="w-[150px]" />
            </div>
            <Select
            ...
            <Button variant="ghost" size="sm" onClick={handleToggleMoreFilters}>
      ...
      <div className="flex flex-1 min-h-0 flex-col space-y-4">
        {glData && (
          <StatCardGrid cols={2}>
            ...
            <StatCard label="Closing Balance" value={formatMoney(glData.closingBalance)} tone="emerald" />
          </StatCardGrid>
        )}
