...
import { disposeAssetSchema, type DisposeFormValues } from "@/features/accounting/assets/asset-schema";
...
export function AssetDetailPage({ assetId }: { assetId: number }) {
  ...
  function handleOpenEdit(): void { setEditOpen(true); }
  function handleOpenActivate(): void { setActivateConfirmOpen(true); }
  function handleOpenDispose(): void { setDisposeOpen(true); }
  function handleEditSuccess(): void { void refetch(); }
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            {asset.status === "ACTIVE" && canManage && (
              <Button size="sm" variant="destructive" onClick={handleOpenDispose}>
                Dispose
              </Button>
            )}
          </div>
