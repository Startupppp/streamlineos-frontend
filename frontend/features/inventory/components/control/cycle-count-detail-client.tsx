...
export function CycleCountDetailClient({ countId }: Props) {
  ...
  return (
    <>
      <PageWrapper
        eyebrow="Operations · Inventory"
        title={isLoading ? "Cycle Count" : `Cycle Count #${count?.countNumber ?? ""}`}
        backHref="/inventory/cycle-counts"
        badge={
          status ? (
            <Badge
        ...
        <DataTable
          ...
          emptyState={
            <EmptyState
              compact
              title="No lines"
              description="No inventory lines are assigned to this count."
      ...
      <AlertDialog open={postDialogOpen} onOpenChange={setPostDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Post Cycle Count</AlertDialogTitle>
            <AlertDialogDescription>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={handleConfirmPost}>Post Count</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </>
