                ...
                {statutoryPack.items.map((item) => (
                  <div key={item.key} className="flex items-center justify-between px-4 py-3 gap-4">
                    ...
                    <span
                      className={
                        item.enabled
                          ? "inline-flex items-center px-1.5 py-0.5 rounded text-micro font-medium border bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-300 dark:border-emerald-500/30"
                  ...
                  <div className="space-y-1">
                    {statutoryPack.complianceChecklist.map((cl) => (
                      <div key={cl.key}>
                        ...
                        <p className="text-dense text-blue-600 dark:text-blue-400">{cl.detail}</p>
                      </div>
                    ))}
                  </div>
                </div>
