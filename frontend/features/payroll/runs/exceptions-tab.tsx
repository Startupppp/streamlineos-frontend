...
> = {
  BLOCKER: { className: "bg-red-50 text-red-700 border-red-200", label: "Blocker" },
  WARNING: { className: "bg-amber-50 text-amber-700 border-amber-200", label: "Warning" },
  INFO: { className: "bg-blue-50 text-blue-700 border-blue-200", label: "Info" },
};

const STATUS_CONFIG: Record<PayrollExceptionStatus, { className: string; label: string }> = {
  OPEN: { className: "bg-slate-100 text-slate-600 border-slate-200", label: "Open" },
  RESOLVED: { className: "bg-emerald-50 text-emerald-700 border-emerald-200", label: "Resolved" },
  OVERRIDDEN: { className: "bg-slate-100 text-slate-500 border-slate-200", label: "Overridden" },
};
