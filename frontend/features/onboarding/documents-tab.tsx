...
const DOCUMENT_TYPES = [
  {
    ...
    hint: "Passport / Aadhar / License",
  },
  {
    type: "CERTIFICATE",
    label: "Educational Certificates",
    hint: "Highest Degree / Diploma",
  },
              ...
              return (
                ...
                >
                  ...
                  <Label
                    ...
                    className="font-medium text-sm cursor-pointer leading-tight"
                  >
                    {doc.label}
                    {isRequired && (
                  ...
                  {uploadedFiles[doc.type] ? (
                    <span className="text-xs text-emerald-600 font-medium truncate max-w-full">
                      {uploadedFiles[doc.type]}
                    </span>
                  ) : (
                    <span className="text-[11px] text-muted-foreground/60">
                      Max {MAX_FILE_SIZE_MB}MB · {FILE_HINT}
                    </span>
                  )}
                  <input
                    ref={(el) => {
