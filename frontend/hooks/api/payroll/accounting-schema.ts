...
export const accountingMappingContract = z.object({
  id: z.number(),
  orgId: z.string(),
...
export const accountingMappingListContract = z.array(accountingMappingContract);
...
export type AccountingMapping = z.infer<typeof accountingMappingContract>;
