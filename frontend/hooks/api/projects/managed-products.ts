...
export function useManagedProducts(params?: ListManagedProductsParams) {
  const canView = useCan("projects:managed-products:view");
  ...
  return useQuery<ManagedProductsPage>({
    ...
    queryFn: () =>
      apiClient.get<ManagedProductsPage>("/projects/managed-products", queryParams),
...
export function useManagedProduct(managedProductId: number) {
  ...
  return useQuery<ManagedProduct>({
    ...
    queryFn: () =>
      apiClient.get<ManagedProduct>(`/projects/managed-products/${managedProductId}`),
...
export function useCreateManagedProduct() {
  ...
  return useMutation({
    ...
    mutationFn: (data: CreateManagedProductInput) =>
      apiClient.post<ManagedProduct>("/projects/managed-products", data),
    onSuccess: () => {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      apiClient.patch<ManagedProduct>(
        `/projects/managed-products/${managedProductId}`,
        data,
      ),
...
export function useDeleteManagedProduct() {
  ...
  return useMutation({
    ...
    mutationFn: (managedProductId: number) =>
      apiClient.delete<void>(`/projects/managed-products/${managedProductId}`),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: queryKeys.projects.managedProducts.list() });
    },
  });
