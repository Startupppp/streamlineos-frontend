...
const clientAccountRowSchema = z.object({
  ...
  status: z.enum(["ACCOUNT_OPENING", "QUERIES", "PLAN_SELECTED", "INVESTED"] as const),
...
const opportunityRowSchema = z.object({
  ...
  title: z.string(),
  type: z.enum(["upsell", "cross_sell"] as const),
  stage: z.enum(["identified", "proposed", "negotiating", "won", "lost"] as const),
