...
export const supportRoutingRuleRowContract = z.object({
  ...
  setPriority: z.enum(["LOW", "MEDIUM", "HIGH", "URGENT"]).nullable(),
...
export const supportSettingsAuditLogRowContract = z.object({
  ...
  orgId: z.string(),
  userId: z.string().nullable(),
  entityType: z.enum(["sla_policy", "business_hours", "automation", "channel", "custom_field", "routing_rule", "agent_skill", "agent_availability", "vip_client"]),
  entityId: z.string(),
