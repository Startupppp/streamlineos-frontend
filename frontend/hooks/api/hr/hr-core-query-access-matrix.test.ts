...
const queryAccessCases: readonly QueryAccessCase[] = [
  ["employees.ts", "useHrDepartments", "/hr/departments", "hr:employees:view", true],
  ["employees.ts", "useLegacyHrDepartments", "/hr/departments/legacy", "hr:employees:view", true],
  ["employees.ts", "useHrEmployees", "/hr/employees", "hr:employees:view", true],
  ["employees.ts", "useInfiniteHrEmployees", "/hr/employees", "hr:employees:view", true],
  ["employees.ts", "useHrEmployeeStats", "/hr/employees/stats", "hr:employees:view", true],
  ["employees.ts", "useHrEmployeeProjects", "/hr/employees/projects", "hr:employees:view", true],
  ["employees.ts", "useHrEmployeeTickets", "/hr/employees/tickets", "hr:employees:view", true],
  ["employees.ts", "useEmployeeAvailability", "/hr/employees/availability", "hr:employees:view", true],
  ["employees.ts", "useFindExpert", "/hr/employees/find-expert", "hr:employees:view", true],
  ["employees.ts", "useSkillsMatrix", "/hr/employees/skills-matrix", "hr:employees:view", true],
  ["employees.ts", "useDirectReports", "/reports-to-me", "hr:employees:view", true],
  ["employees.ts", "useManagerScorecard", "/manager-scorecard", "hr:employees:view", true],
  ["employees.ts", "useEmployeeEmployment", "/employment", "hr:employees:view", true],
  ["employees.ts", "useEmployeeTimeline", "/timeline", "hr:employees:view", true],
  ["employees.ts", "useEmployeeSensitive", "/sensitive", "hr:sensitive:view", true],
