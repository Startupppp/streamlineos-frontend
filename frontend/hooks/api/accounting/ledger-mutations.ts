...
export function useSetAccountSystemTag() {
  ...
  >("accounting:accounts:manage", {
    ...
    mutationFn: ({ accountId, systemTag }) =>
      apiClient.patch<AccountNode>(
        `/accounting/accounts/${accountId}/system-tag`,
        { systemTag },
      ),
    onSuccess: () => {
      queryClient.invalidateQueries({
...
export function useCreateAccount() {
  const queryClient = useQueryClient();
  return useAuthorizedMutation<AccountNode, Error, CreateAccountInput>(
    "accounting:accounts:create",
    {
      mutationKey: ["accounting", "accounts", "create"],
      mutationFn: (input) =>
        apiClient.post<AccountNode>("/accounting/accounts", input),
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: accountingLedgerQueryKeys.accountingLedger.all,
        });
...
export function useUpdateAccount() {
  ...
  >("accounting:accounts:update", {
    ...
    onSuccess: (_data, variables) => {
      queryClient.invalidateQueries({
        queryKey: accountingLedgerQueryKeys.accountingLedger.accounts(),
      });
      queryClient.invalidateQueries({
        queryKey: accountingLedgerQueryKeys.accountingLedger.account(
          variables.accountId,
        ),
      });
      queryClient.invalidateQueries({
...
export function useLockPeriod() {
  ...
  >("accounting:periods:manage", {
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: accountingLedgerQueryKeys.accountingLedger.periods(),
      });
    },
  });
}
...
export function useUnlockPeriod() {
  ...
  >("accounting:periods:reopen", {
    ...
    mutationFn: ({ periodId, reason }) =>
      apiClient.post<AccountingPeriod>(
...
export function useOpenNextFiscalYear() {
  const queryClient = useQueryClient();
  return useAuthorizedMutation<FiscalYear, Error, void>(
    "accounting:periods:manage",
    {
      mutationKey: ["accounting", "fiscalYears", "openNext"],
      mutationFn: () =>
        apiClient.post<FiscalYear>("/accounting/fiscal-years/open-next", {}),
      onSuccess: () => {
        queryClient.invalidateQueries({
...
export function usePostJournal() {
  const queryClient = useQueryClient();
  return useAuthorizedMutation<Journal, Error, PostJournalInput>(
    "accounting:journal:post",
    {
      mutationKey: ["accounting", "journals", "post"],
      mutationFn: (input) =>
        apiClient.post<Journal>("/accounting/journals/post", input),
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: accountingLedgerQueryKeys.accountingLedger.all,
        });
...
export function useUpsertFxRate() {
  ...
  >("accounting:settings:manage", {
    ...
    mutationFn: (input) =>
      apiClient.post<FxRate>("/accounting/fx-rates", input),
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: accountingLedgerQueryKeys.accountingLedger.fxRates(),
      });
    },
  });
}
...
export function usePreviewFx() {
  ...
  >("accounting:read", {
    ...
    mutationFn: (input) =>
      apiClient.post<FxPreview>("/accounting/fx/preview", input),
  });
}
...
export function usePreviewOpeningBalances() {
  ...
  >("accounting:settings:read", {
    ...
    mutationFn: (input) =>
      apiClient.post<OpeningBalancesPreview>(
        "/accounting/setup/opening-balances/preview",
        input,
      ),
  });
}
...
export function usePostOpeningBalances() {
  const queryClient = useQueryClient();
  return useAuthorizedMutation<Journal, Error, OpeningBalancesInput>(
    "accounting:journal:post",
    {
      mutationKey: ["accounting", "openingBalances", "post"],
      mutationFn: (input) =>
        apiClient.post<Journal>("/accounting/setup/opening-balances", input),
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: accountingLedgerQueryKeys.accountingLedger.all,
        });
...
export function useAddTaxRegistration() {
  ...
  >("accounting:settings:manage", {
    ...
    mutationFn: (input) =>
      apiClient.post<TaxRegistration>(
