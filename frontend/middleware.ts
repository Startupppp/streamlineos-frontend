...
const ROUTE_PERMISSION_MAP: Record<string, string[]> = {
  ...
  "/projects/goal": ["projects:goals:view"],
  "/goals": ["projects:goals:view"],
  "/timesheets": ["projects:timesheets:view", "timesheets:entries:view"],
  "/timesheets/team": ["timesheets:team:view"],
  "/timesheets/approvals": ["timesheets:approvals:view"],
  "/timesheets/billing": ["timesheets:billing:view"],
  "/timesheets/payroll": ["timesheets:payroll:view"],
  "/timesheets/reports": ["timesheets:reports:view"],
  "/timesheets/settings": ["timesheets:settings:view"],
  ...
  "/support/portal": ["support:portal:tickets:view"],
  "/support/settings/sla": ["support:settings:manage"],
  ...
  "/hr/settings/automations": ["settings:automations:view"],
  "/support/settings/automations": ["settings:automations:view"],
  "/accounting/settings/automations": ["settings:automations:view"],
...
export default async function middleware(req: NextRequest) {
  ...
  if (
    ...
    if (
      ...
      !canAccessRoute(pathname, isPlatformAdmin, isOrgOwner, userPermissions)
    ) {
      const url = req.nextUrl.clone();
