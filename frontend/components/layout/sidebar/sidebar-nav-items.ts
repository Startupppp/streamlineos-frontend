    ...
    routes: [
      {
        ...
        children: [
          ...
          { label: "Hiring Flows", icon: ListChecks, href: "/hr/recruitment/hiring-flows", requiredPermission: "hr:employees:create" },
          { label: "SLA Config", icon: Clock, href: "/hr/recruitment/sla", requiredPermission: "hr:employees:create" },
          { label: "SLA Report", icon: BarChart2, href: "/hr/recruitment/sla-report", requiredPermission: "hr:employees:create" },
          { label: "Analytics", icon: BarChart3, href: "/hr/recruitment/analytics", requiredPermission: "hr:employees:create" },
          { label: "Diversity Report", icon: Users, href: "/hr/recruitment/diversity-report", requiredPermission: "hr:employees:create" },
          ...
          { label: "Internal Jobs", icon: Briefcase, href: "/hr/recruitment/internal-jobs" },
          { label: "Offer Templates", icon: LayoutTemplate, href: "/hr/recruitment/offer-templates", requiredPermission: "hr:employees:create" },
          { label: "Recruiters", icon: UserCog, href: "/hr/recruitment/recruiters", requiredPermission: "hr:employees:create" },
          ...
          { label: "Reports", icon: FileSearch, href: "/hr/recruitment/reports", requiredPermission: "hr:employees:view" },
        ],
      },
    ],
  },
    ...
    routes: [
      {
        ...
        children: [
          ...
          { label: "Calendar Integration", icon: CalendarCheck, href: "/settings/integrations/calendar" },
