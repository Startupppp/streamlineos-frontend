...
export function SalaryStructureForm({ userId, onSuccess }: SalaryStructureFormProps) {
      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <Input type="number" step="0.1" {...register("hraPercentage", { valueAsNumber: true })} />
            {errors.hraPercentage && (
              <p className="text-sm text-red-500">{errors.hraPercentage.message}</p>
            )}
          </div>
          <div>
            ...
            {errors.allowances && (
              <p className="text-sm text-red-500">{errors.allowances.message}</p>
            )}
          </div>
          <div>
            ...
            {errors.deductions && (
              <p className="text-sm text-red-500">{errors.deductions.message}</p>
            )}
          </div>
          <div>
