  ...
  return (
    <section className="relative py-12 lg:py-16">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="relative rounded-3xl glass-panel-strong overflow-hidden">
          ...
          <div className="relative grid grid-cols-2 lg:grid-cols-4 divide-x divide-y lg:divide-y-0 divide-slate-200/70">
            {stats.map((stat, i) => (
              ...
              >
                <p className="font-display text-4xl lg:text-5xl font-extrabold tracking-tight brand-text mb-1.5 leading-none">
                  <NumberCounter
                    value={stat.value}
                    suffix={stat.suffix}
                    prefix={stat.prefix}
