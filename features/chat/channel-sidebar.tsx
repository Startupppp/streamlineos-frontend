...
import { useLeaveChannel } from "@/lib/api/hooks/chat";
...
function ChannelListEntry({ channel: ch, activeChannelId, currentUserId, onlineUserIds, onSelectChannel, onLeave }: ChannelListEntryProps) {
