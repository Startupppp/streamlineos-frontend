  ...
  const html = `
    ...
    <html>
      <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Welcome to Vaivamm CRM</title>
      </head>
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
        ...
        <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
          <p>Hi ${name},</p>
          <p>Welcome to Vaivamm CRM! Your account has been created successfully.</p>
          ...
          <div style="background: #fff; padding: 15px; border-left: 4px solid #667eea; margin: 20px 0;">
            ...
            <p style="margin: 5px 0 0;">Email: <strong>${email}</strong></p>
            <p style="margin: 5px 0 0;">Temporary Password: <strong>${tempPassword}</strong></p>
          </div>
          ...
          <p style="font-size: 12px; color: #666;">Or copy and paste this link into your browser:</p>
          <p style="font-size: 12px; color: #667eea; word-break: break-all;">${loginUrl}</p>
        </div>
      </body>
    </html>
  `;
