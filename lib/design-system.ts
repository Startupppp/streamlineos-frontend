...
export const DS = {
  ...
  cardElevated:
    "rounded-2xl border border-slate-200/80 bg-white/90 backdrop-blur-sm shadow-[0_18px_44px_-18px_rgba(30,64,175,0.18)]",
  cardSoft: "rounded-xl border border-slate-200/80 bg-white/70 backdrop-blur-sm",

  heading1:
    "font-display text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-[-0.03em] leading-[1.05] text-slate-900",
  heading2:
    "font-display text-2xl lg:text-3xl font-extrabold tracking-[-0.02em] text-slate-900",
  heading3: "font-display text-xl font-bold text-slate-900",
  heading4: "text-base font-semibold tracking-tight text-foreground",

  textBody: "text-sm text-slate-700 leading-relaxed",
  textMuted: "text-sm text-muted-foreground",
  textSmall: "text-[13px] text-slate-600",
  textXs: "text-xs text-muted-foreground",

  eyebrow:
    "text-[11px] font-mono uppercase tracking-[0.18em] text-blue-600",
  monoMeta:
    "text-[11px] font-mono uppercase tracking-[0.14em] text-slate-500",
