...
|---|---|---:|---:|---:|---:|
| Q1-board-page1 | Board / list, page 1, sorted by manual order (the benchmark) | 0.18 | 50 | 55 | 0 |
| Q2-board-deep-page | Same list at offset 3000 (offset pagination cost) | 4.49 | 50 | 3079 | 0 |
| Q3-list-count | The COUNT(*) fired alongside every list request | 0.88 | 1 | 18 | 0 |
| Q4-search-ilike | Search: leading-wildcard ILIKE on title | 4.33 | 2 | 3339 | 0 |
| Q5-board-with-relations | Board page 1 hydrated with assignees + labels (the relational `with` shape) | 0.89 | 50 | 391 | 1 |
| Q6-my-work | My Work: assigned tickets across the whole org | 0.16 | 50 | 53 | 0 |
| Q7-status-counts | Per-column badge counts for the board | 0.97 | 1 | 18 | 0 |
| Q8-ticket-comments | Ticket detail: comment thread | 0.07 | 2 | 5 | 0 |
| Q9-ticket-activity | Ticket detail: activity feed | 0.08 | 2 | 5 | 0 |
| Q10-dependency-graph | Dependency edges for a ticket (blocks / blocked_by) | 0.09 | 0 | 4 | 0 |
| Q11-portfolio-rollup | Portfolio dashboard: per-project open/done rollup across the org | 134.44 | 50 | 1311 | 1 |
| Q12-timesheet-billing-rollup | Billing: approved billable hours + amount by project | 41.54 | 21 | 4474 | 0 |
...
| tickets | 204000 | 91 MB | 65 MB | 156 MB |
...
| projects | projects_pkey | 573 | 16 kB |
...
| ticket_activity_log | idx_ticket_activity_log_org_ticket | 7 | 44 MB |
...
| ticket_assignees | uniq_ticket_assignees_ticket_user | 172514 | 17 MB |
| ticket_comments | uniq_ticket_comments_org_id | 2 | 33 MB |
| ticket_comments | idx_ticket_comments_ticket | 505 | 11 MB |
...
| ticket_label_mappings | uniq_ticket_label_mappings_ticket_label | 100350 | 2752 kB |
...
| tickets | idx_tickets_title_trgm | 3 | 16 MB |
| tickets | idx_tickets_org_assignee_due_open | 4 | 1264 kB |
| tickets | idx_tickets_org_project_order | 32 | 13 MB |
| tickets | idx_tickets_sprint | 65 | 1288 kB |
| tickets | idx_tickets_parent | 250 | 1288 kB |
| tickets | idx_tickets_org_project_status | 1179 | 1560 kB |
| tickets | uniq_tickets_org_id | 1381564 | 14 MB |
| tickets | tickets_pkey | 1658853 | 4496 kB |
...
| timesheets | idx_timesheets_org_status | 4 | 1016 kB |
...
| work_item_relations | idx_work_item_relations_item | 5 | 1392 kB |
| work_item_relations | idx_work_item_relations_related | 6 | 1392 kB |
...
```
  ...
  Incremental Sort
  Result
  Index Scan on tickets using idx_tickets_org_project_order
```
