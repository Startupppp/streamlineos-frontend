...
**Status:** done, with five surfaces deliberately left and named below.
...
- [x] Every remaining CRM record type renders through the Phase 1 engine.
      Thirty-seven descriptions in `lib/renderer/crm/`, all registered in
...
- [x] **No hand-written CRM list, table or form remains**, except the surfaces
      ...
      Five further exceptions are argued below rather than forced.
...
each argued above. 37 record descriptions live in `lib/renderer/crm/`, all
