...
`leads` — roughly 19 module files — still read a legacy identity table.
...
- [ ] Lead-specific fields read from the columns Party absorbed in ticket 01.
- [ ] Lead conversion produces one Party that was already the lead, never a second row.
