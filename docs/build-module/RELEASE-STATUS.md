...
- Backend release commit `768f15297` is contained in backend `origin/main`; the health endpoint responds 200 at `https://api.streamlineos.in/health`. The latest analytics, project-bound workflow-read, and bounded ticket-detail relation fixes are pushed and await the normal deployment rollout.
