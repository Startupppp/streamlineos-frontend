...
- **Current/target route:** `/build/[projectId]/settings/retention`
- **Scope:** project
- **Disposition:** **ADD**
...
- [ ] Lists are bounded/virtualized and remain usable at 10k work items and 1k members.
  BLOCKED — nothing to bound yet: `app/(authenticated)/build/[projectId]/settings/retention/page.tsx:15` renders a `RetentionPlaceholder` EmptyState stating the policy work awaits open question 9. No list exists.
