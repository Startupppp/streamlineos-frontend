...
- **Current/target route:** `/build/[projectId]/analytics`
- **Scope:** project
- **Disposition:** **CONSOLIDATE**
- **Decision:** Migrate the user job to `/build/[projectId]/reports?tab=overview`, preserve deep links temporarily, then remove this physical route.
- **User job:** Explain flow, predictability, and schedule using drillable evidence.
- **Evidence:** `frontend/app/(authenticated)/build/[projectId]/analytics/page.tsx`; Project 6 rendered only `Board`; consolidate into Reports.
...
- Existing feature evidence: `@/features/build/analytics/project-analytics-page`
