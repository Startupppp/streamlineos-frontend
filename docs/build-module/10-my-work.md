...
- **Current/target route:** `/build/my-work`
- **Scope:** organization
- **Disposition:** **KEEP**
...
- **Evidence:** `frontend/app/(authenticated)/build/my-work/page.tsx`; Production URL remained `/build/my-work` but rendered the All Projects surface during the bounded audit.
