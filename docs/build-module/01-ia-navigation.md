...
| `/build/[projectId]/automations` | Configure event-driven project rules. | Project administrator. | [MOVE](./10-project-automations.md) | Migrate the user job to `/build/[projectId]/settings/automations`, preserve deep links temporarily, then remove this physical route. |
...
| `/build/[projectId]/intake` | Classify and convert incoming evidence into canonical work. | Product/project manager. | [CONSOLIDATE](./10-project-intake.md) | Migrate the user job to `/build/[projectId]/forms and /build/[projectId]/triage`, preserve deep links temporarily, then remove this physical route. |
...
| `/build/[projectId]/my-tickets` | Unify work assigned to, reported by, or watched by the current actor. | Contributor. | [CONSOLIDATE](./10-project-my-tickets.md) | Migrate the user job to `/build/my-work?projectId=...`, preserve deep links temporarily, then remove this physical route. |
...
| `/build/[projectId]/webhooks` | Configure outbound project event delivery. | Project administrator. | [MOVE](./10-project-webhooks.md) | Migrate the user job to `/build/[projectId]/settings/integrations/webhooks`, preserve deep links temporarily, then remove this physical route. |
...
| `/build/[projectId]/workflow` | Configure statuses, transitions, WIP, and required fields. | Project administrator. | [MOVE](./10-project-workflow.md) | Migrate the user job to `/build/[projectId]/settings/workflow`, preserve deep links temporarily, then remove this physical route. |
...
| `/build/access` | Administer Build access at organization scope. | Organization administrator. | [MOVE — done](./10-access.md) | Migrated to `/build/settings/access`. Physical route deleted; the deep link is preserved by the `next.config.ts` redirect. |
...
| `/build/client-access` | Administer Build access at organization scope. | Organization administrator. | [MOVE](./10-client-access.md) | Migrate the user job to `/build/settings/client-access`, preserve deep links temporarily, then remove this physical route. |
...
| `/build/drafts` | Collect actionable Build notifications and recover drafts. | Contributor. | [CONSOLIDATE](./10-drafts.md) | Migrate the user job to `/build/inbox?view=drafts`, preserve deep links temporarily, then remove this physical route. |
...
| `/build/members` | Administer Build access at organization scope. | Organization administrator. | [MOVE](./10-members.md) | Migrate the user job to `/build/settings/access`, preserve deep links temporarily, then remove this physical route. |
...
| `/build/workspaces/[pmWorkspaceId]/my-work` | Unify work assigned to, reported by, or watched by the current actor. | Contributor. | [CONSOLIDATE](./10-workspaces-workspace-my-work.md) | Migrate the user job to `/build/my-work?pmWorkspaceId=...`, preserve deep links temporarily, then remove this physical route. |
