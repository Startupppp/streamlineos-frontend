...
| `/build/access` | Administer Build access at organization scope. | Organization administrator. | [MOVE](./10-access.md) | Migrate the user job to `/build/settings/access`, preserve deep links temporarily, then remove this physical route. |
