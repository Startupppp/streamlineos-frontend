...
- **Current/target route:** `/build/workspaces/[pmWorkspaceId]/roadmap`
- **Scope:** workspace
- **Disposition:** **KEEP**
...
- **Evidence:** `frontend/app/(authenticated)/build/workspaces/[pmWorkspaceId]/roadmap/page.tsx`; Route existence verified in the repository; live behavior not directly observed with a valid detail record. **ASSUMPTION:** the page follows its source component until browser evidence is captured.
...
- Existing feature evidence: `@/features/build/pm-workspaces/workspace-roadmap-page`
