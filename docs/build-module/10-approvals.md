...
- **Current/target route:** `/build/approvals`
- **Scope:** organization
- **Disposition:** **KEEP**
...
- **Evidence:** `frontend/app/(authenticated)/build/approvals/page.tsx`; Route existence verified in the repository; live behavior not directly observed with a valid detail record. **ASSUMPTION:** the page follows its source component until browser evidence is captured.
...
- Existing feature evidence: `@/features/build/approvals/approvals-inbox-page`
