...
async function seed() {
  ...
  const peopleData = [
    { slug: "sarah-mitchell", name: "Sarah Mitchell", initials: "SM", role: "sales_rep" as const, title: "Senior Account Executive", department: "Sales", email: "sarah.mitchell@streamlineos.app", phone: "+1 (415) 555-0142", location: "San Francisco, CA", joinDate: "Mar 2022", bio: "Top-performing AE with expertise in enterprise SaaS sales.", skills: ["Enterprise Sales", "Consultative Selling", "SaaS", "Contract Negotiation", "C-Suite Engagement"] },
    { slug: "jason-lee", name: "Jason Lee", initials: "JL", role: "sales_rep" as const, title: "Account Executive", department: "Sales", email: "jason.lee@streamlineos.app", phone: "+1 (415) 555-0198", location: "San Francisco, CA", joinDate: "Jun 2022", bio: "Strategic seller with deep expertise in the financial services vertical.", skills: ["Technical Sales", "Financial Services", "Solution Architecture", "Multi-threading", "POC Management"] },
    { slug: "maria-kim", name: "Maria Kim", initials: "MK", role: "sales_rep" as const, title: "Account Executive", department: "Sales", email: "maria.kim@streamlineos.app", phone: "+1 (212) 555-0167", location: "New York, NY", joinDate: "Sep 2022", bio: "Relationship-driven seller with expertise in healthcare and life sciences.", skills: ["Healthcare Sales", "Account Expansion", "Relationship Building", "Renewal Management", "Cross-sell"] },
    { slug: "alex-park", name: "Alex Park", initials: "AP", role: "sales_rep" as const, title: "Business Development Rep", department: "Sales", email: "alex.park@streamlineos.app", phone: "+1 (512) 555-0134", location: "Austin, TX", joinDate: "Jan 2023", bio: "High-energy BDR transitioning into a closing role.", skills: ["Outbound Prospecting", "Pipeline Generation", "Mid-Market", "Cold Calling", "Demo Skills"] },
    { slug: "daniel-chen", name: "Daniel Chen", initials: "DC", role: "sales_rep" as const, title: "Account Executive", department: "Sales", email: "daniel.chen@streamlineos.app", phone: "+1 (310) 555-0189", location: "Los Angeles, CA", joinDate: "Apr 2023", bio: "Data-driven seller specializing in manufacturing and logistics.", skills: ["Manufacturing", "Logistics", "ROI Analysis", "Data-Driven Selling", "Business Case Development"] },
    { slug: "emma-watson", name: "Emma Watson", initials: "EW", role: "csm" as const, title: "Senior Customer Success Manager", department: "Customer Success", email: "emma.watson@streamlineos.app", phone: "+1 (415) 555-0211", location: "San Francisco, CA", joinDate: "Jan 2022", bio: "Seasoned CSM with a proactive approach to customer health management.", skills: ["Account Management", "Executive Relationships", "Adoption", "Renewal Strategy", "Stakeholder Mapping"] },
    { slug: "ryan-torres", name: "Ryan Torres", initials: "RT", role: "csm" as const, title: "Customer Success Manager", department: "Customer Success", email: "ryan.torres@streamlineos.app", phone: "+1 (212) 555-0244", location: "New York, NY", joinDate: "May 2022", bio: "Technical CSM specializing in complex integrations and deep product adoption.", skills: ["Technical CSM", "Integrations", "Product Adoption", "Risk Management", "Technical Documentation"] },
    { slug: "lisa-huang", name: "Lisa Huang", initials: "LH", role: "csm" as const, title: "Customer Success Manager", department: "Customer Success", email: "lisa.huang@streamlineos.app", phone: "+1 (512) 555-0178", location: "Austin, TX", joinDate: "Aug 2023", bio: "Customer-centric CSM with exceptional onboarding skills.", skills: ["Onboarding", "Training", "Time-to-Value", "Change Management", "Customer Education"] },
  ];
