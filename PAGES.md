...
- [x] `/projects/whiteboards` — Whiteboards hub (org-wide ACL-filtered board grid via `GET /whiteboards`, cap 100, project-name join; cards deep-link `?board=`; "Whiteboards" entry added to the Projects & Time sidebar group; migrations 0137/0138 APPLIED + `backfill:rbac` run + access versions bumped on 2026-07-03)
