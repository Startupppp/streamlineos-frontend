      ...
      return [
        ...
        },
        {
          ...
          routes: [
            ...
            { label: "Reimbursements", icon: Receipt, href: "/hr/reimbursements", isSubItem: true },
            ...
            { label: "Asset returns", icon: Package, href: "/hr/asset-returns", isSubItem: true },
            { label: "Performance", icon: Star, href: "/hr/performance" },
            { label: "Bonuses", icon: DollarSign, href: "/hr/bonuses", isSubItem: true },
            { label: "Incentives", icon: Star, href: "/hr/incentives", isSubItem: true },
            ...
            { label: "Learning paths", icon: BookOpen, href: "/hr/learning-paths", isSubItem: true },
            { label: "Career ladders", icon: TrendingUp, href: "/hr/career-ladders", isSubItem: true },
            { label: "Skills", icon: Trophy, href: "/hr/skills", isSubItem: true },
            { label: "Certifications", icon: Trophy, href: "/hr/certifications", isSubItem: true },
            { label: "Assessments", icon: ClipboardList, href: "/hr/assessments", isSubItem: true },
            { label: "Surveys", icon: ClipboardList, href: "/hr/surveys", isSubItem: true },
            { label: "Recognition", icon: Heart, href: "/hr/recognition" },
            { label: "eNPS", icon: BarChart3, href: "/hr/enps", isSubItem: true },
            { label: "Team events", icon: CalendarDays, href: "/hr/team-events", isSubItem: true },
            { label: "Handbook", icon: BookOpen, href: "/hr/handbook", isSubItem: true },
            { label: "Work logs", icon: Timer, href: "/hr/work-logs", isSubItem: true },
            { label: "Loans", icon: Wallet, href: "/hr/loans", isSubItem: true },
            { label: "Compliance", icon: ShieldCheck, href: "/hr/compliance", isSubItem: true },
            { label: "Background verification", icon: ShieldCheck, href: "/hr/background-verification", isSubItem: true },
            { label: "Alumni", icon: Users, href: "/hr/alumni", isSubItem: true },
        ...
        },
        {
          ...
          routes: [
            ...
            { label: "Reports", icon: FileText, href: "/crm/reports" },
            ...
            { label: "CRM Settings", icon: SlidersHorizontal, href: "/crm/settings/assignment-rules" },
            { label: "Assignment rules", icon: SlidersHorizontal, href: "/crm/settings/assignment-rules", isSubItem: true },
            { label: "Scoring rules", icon: SlidersHorizontal, href: "/crm/settings/scoring-rules", isSubItem: true },
            { label: "SLA", icon: Clock, href: "/crm/settings/sla", isSubItem: true },
            { label: "Email templates", icon: Mail, href: "/crm/settings/email-templates", isSubItem: true },
          ],
        },
        {
          label: "Dashboards",
