...
| 02 | [Six overlapping route groups become one each](issues/02-overlapping-route-groups-become-one-each.md) | — | done — 1 collision fixed; PRD count corrected from six |
