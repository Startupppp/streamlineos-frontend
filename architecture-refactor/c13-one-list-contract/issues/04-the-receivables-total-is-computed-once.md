...
- [ ] Compare totals before and after on real-shaped data — **BLOCKED:** requires a booted app against real data. Same caveat as the criterion above: there is no "before" to compare against, because the double aggregation the ticket describes was already gone.
