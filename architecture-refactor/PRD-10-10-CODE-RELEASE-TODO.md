...
- [x] [S06 — Build and Workflows](code-release-sessions/S06-BUILD-WORKFLOWS.md) — 125 suites / 836 tests green, 13 services moved onto the membership gate, four runtime-fatal queries fixed, `check:unjoined-table-refs` added. Workflow engine retry/DLQ/cancellation/approval-executor gaps remain open and are named in the session.
