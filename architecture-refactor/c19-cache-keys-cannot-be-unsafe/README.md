...
| 04 | [Every namespace declares its invalidation](issues/04-every-namespace-declares-its-invalidation.md) | 02 | **done** — matrix covers all 46 namespaces; the call-site-migration criterion is withdrawn on evidence |
