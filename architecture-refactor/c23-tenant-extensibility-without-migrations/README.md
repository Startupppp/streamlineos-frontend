...
| 02 | [One module's taxonomy moves to lookup tables](issues/02-one-modules-taxonomy-moves-to-lookup-tables.md) | 01 | **6 of 7** — built and tested on HR positions; last box needs `0543`/`0544` run against real data |
