...
- [ ] Compare tables, columns, types, constraints, indexes, RLS policies and migration hashes between cold and upgraded databases. — blocked until the replay reaches head.
