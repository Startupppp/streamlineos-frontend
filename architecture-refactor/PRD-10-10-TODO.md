...
- Unbounded reads: 282 actionable instances, 0 unclassified paths, and 0 classification regressions in the latest root run. The gate is structurally green, but the zero-actionable ratchet is not complete.
- Migration ledger: 568 applied rows against 579 journal entries; 11 pending; no orphan, duplicate, or unreachable entries.
