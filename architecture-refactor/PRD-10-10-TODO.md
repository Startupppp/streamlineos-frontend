...
- [ ] Re-run cold bootstrap and upgrade-to-head. — **blocked: requires creating a database.**
- [ ] Compare tables, columns, types, constraints, indexes, RLS policies and migration hashes between cold and upgraded databases. — **blocked on the above.**
