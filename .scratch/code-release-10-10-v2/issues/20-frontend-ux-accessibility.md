# 20: Frontend UX and accessibility

**What to build:** Every in-scope flow has responsive, accessible loading, empty, error, offline, permission, retry, and success states.

**Blocked by:** 06–17 — domain slices; 19 — TanStack Query integrity
