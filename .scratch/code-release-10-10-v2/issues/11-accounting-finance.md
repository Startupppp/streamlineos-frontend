...
**What to build:** Financial records, expenses, reconciliation, exports, reminders, retention, and frontend workflows are immutable, bounded, and auditable.

**Blocked by:** 02 — Schema and executable-key minimization; 04 — API, Zod and OpenAPI contracts; 05 — Authentication, Organization, RBAC and Settings; 10 — Billing and Payments
