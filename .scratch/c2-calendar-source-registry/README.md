...
|---|---|---|---|
| 01 | [Turning a calendar source off keeps it off](issues/01-source-toggles-persist-and-are-honoured.md) | — | ready-for-agent |
| 02 | [The calendar shows me which sources are on and lets me change them](issues/02-calendar-ui-turns-a-source-off.md) | 01 | ready-for-agent |
