...
- [ ] The loading, empty, error and no-permission states all still work, and the skeleton still matches the real shape. **Still not verified** — this needs the page driven in a browser, which was not done. **Left unticked by decision (2026-08-24), not oversight:** there is no Playwright or Puppeteer in this repo, and adding browser tooling was declined in favour of manual verification. Everything provable without a browser has been run.
