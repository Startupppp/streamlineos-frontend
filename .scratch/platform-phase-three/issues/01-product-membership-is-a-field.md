...
- [ ] Verified by running the app, not by the types compiling: Workflows appears in a sidebar, and Organization survives with HRMS disabled. (app-level, orchestrator verifies)
